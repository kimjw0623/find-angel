    ...
    <div className="container mx-auto p-4">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex space-x-4 border-b">
          ...
          <button
            className={`py-2 px-4 ${activeTab === 'simulator' 
              ? 'border-b-2 border-blue-500 text-blue-500' 
              : 'text-gray-500 hover:text-gray-700'}`}
      ...
      {activeTab === 'accessory' && <AccessoryDashboard timeRange={timeRange} />}
      {activeTab === 'bracelet' && <BraceletDashboard timeRange={timeRange} />}
      {activeTab === 'simulator' && <EnhancementDashboard />}
    </div>
  );
};
